...
// Include guard.
  ...
  namespace DAC {
    ...
    namespace SafeIntegerErrors {
      ...
      class MaxOverflow : public Overflow  { public: virtual char const* what () const throw(); };
      class MinOverflow : public Overflow  { public: virtual char const* what () const throw(); };
      class DivByZero   : public Base      { public: virtual char const* what () const throw(); };
      class Undefined   : public Base      { public: virtual char const* what () const throw(); };
    ...
    template <class T> class SafeInteger {
      ...
      public:
        ...
        // Logical operator backends.
                            bool op_log_and (SafeInteger<T>  const& number) const;
        template <class RT> bool op_log_and (SafeInteger<RT> const& number) const;
        template <class RT> bool op_log_and (RT              const  number) const;
                            bool op_log_ior (SafeInteger<T>  const& number) const;
        template <class RT> bool op_log_ior (SafeInteger<RT> const& number) const;
        template <class RT> bool op_log_ior (RT              const  number) const;
    ...
    namespace SafeIntegerErrors {
      ...
      inline char const* Base::what        () const throw() { return "Undefined error in SafeInteger.";               }
      inline char const* Overflow::what    () const throw() { return "Overflow in SafeInteger.";                      }
      inline char const* MaxOverflow::what () const throw() { return "SafeInteger operation overflows type maximum."; }
      inline char const* MinOverflow::what () const throw() { return "SafeInteger operation overflows type minimum."; }
      inline char const* DivByZero::what   () const throw() { return "Divide by zero detected in SafeInteger.";       }
      inline char const* Undefined::what   () const throw() { return "Result of operation is undefined.";             }
    ...
    template <class T> SafeInteger<T>& SafeInteger<T>::op_div (SafeInteger<T> const& number) {
      ...
      if (number._number == 0) {
        throw SafeIntegerErrors::DivByZero();
      }
    ...
    template <class T> SafeInteger<T>& SafeInteger<T>::op_shl (SafeInteger<T> const& number) {
      ...
      if (number > std::numeric_limits<T>::digits) {
        throw SafeIntegerErrors::Undefined();
      }
    ...
    // Logical operator backends.
    template <class T>                     bool SafeInteger<T>::op_log_and (SafeInteger<T>  const& number) const { return (_number && number._number); }
    template <class T> template <class RT> bool SafeInteger<T>::op_log_and (SafeInteger<RT> const& number) const { return (_number && number._number); }
    template <class T> template <class RT> bool SafeInteger<T>::op_log_and (RT              const  number) const { return (_number && number);         }
    template <class T>                     bool SafeInteger<T>::op_log_ior (SafeInteger<T>  const& number) const { return (_number || number._number); }
