...
modules = []
tmpenv = env.Copy()
cUArbInt       = SConscript(['UArbInt/SConscript'      ], exports = 'env'                           ) ; env = tmpenv.Copy() ; modules.append(cUArbInt      )
cArbInt        = SConscript(['ArbInt/SConscript'       ], exports = 'env cUArbInt'                  ) ; env = tmpenv.Copy() ; modules.append(cArbInt       )
cArb           = SConscript(['Arb/SConscript'          ], exports = 'env cUArbInt'                  ) ; env = tmpenv.Copy() ; modules.append(cArb          )
...
cValReader     = SConscript(['ValReader/SConscript'    ], exports = 'env cUArbInt cArb'             ) ; env = tmpenv.Copy() ; modules.append(cValReader    )
...
# Tests.
SConscript(['Tests/SConscript'], exports = 'env cArbInt cUArbInt cArb cTimestamp cINIFile cget_errorText cValReader ctokenize ctrim') ; env = tmpenv.Copy()
